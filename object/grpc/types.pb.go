...
type SplitInfo struct {
	...
	FirstPart *grpc.ObjectID `protobuf:"bytes,4,opt,name=first_part,json=firstPart,proto3" json:"first_part,omitempty"`
}
...
func (x *SplitInfo) GetFirstPart() *grpc.ObjectID {
	if x != nil {
		return x.FirstPart
	}
	return nil
...
type Header_Split struct {
	...
	// Identifier of the first part of the origin object. Known to all the split
	// parts except the first one. Identifies the split and allows to differ them.
	First *grpc.ObjectID `protobuf:"bytes,7,opt,name=first,proto3" json:"first,omitempty"`
}
...
func (x *Header_Split) GetFirst() *grpc.ObjectID {
	if x != nil {
		return x.First
	}
	return nil
