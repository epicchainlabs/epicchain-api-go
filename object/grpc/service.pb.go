...
func (x *ReplicateRequest) GetSignature() *grpc1.Signature {
	if x != nil {
		return x.Signature
	}
	return nil
...
type ReplicateResponse struct {
	...
	Status *grpc2.Status `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
}
...
func (x *ReplicateResponse) GetStatus() *grpc2.Status {
	if x != nil {
		return x.Status
	}
	return nil
...
var file_object_grpc_service_proto_goTypes = []interface{}{
	...
	(*grpc.RequestMetaHeader)(nil),          // 35: neo.fs.v2.session.RequestMetaHeader
	(*grpc.RequestVerificationHeader)(nil),  // 36: neo.fs.v2.session.RequestVerificationHeader
	(*grpc.ResponseMetaHeader)(nil),         // 37: neo.fs.v2.session.ResponseMetaHeader
	(*grpc.ResponseVerificationHeader)(nil), // 38: neo.fs.v2.session.ResponseVerificationHeader
	(*Header)(nil),                          // 39: neo.fs.v2.object.Header
	(*grpc1.Signature)(nil),                 // 40: neo.fs.v2.refs.Signature
	(*Object)(nil),                          // 41: neo.fs.v2.object.Object
	(*grpc2.Status)(nil),                    // 42: neo.fs.v2.status.Status
